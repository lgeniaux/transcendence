...
urlpatterns = [
    ...
    path(
        ...
        CreateTournament.as_view(),
        name="create-tournament",
    ),
    path(
        "tournament/get-tournaments/",
        GetMyTournaments.as_view(),
        name="get-tournaments",
    ),
    path(
        "tournament/<int:tournament_id>/state/",
        GetTournamentState.as_view(),
        name="get-tournament-state",
    ),
    path(
        "tournament/invite/", InvitePlayerToTournament.as_view(), name="invite-player"
    ),
    path(
        "get-notifications/", GetUserNotifications.as_view(), name="get-notifications"
    ),
    path(
        "respond-to-invite/",
        ManageInvitationNotification.as_view(),
        name="respond-to-invite",
    ),
    path(
        "get-messages/",
        GetConversationMessages.as_view(),
        name="get-conversation-messages",
    ),
    path("game/invite/", InvitePlayerToGame.as_view(), name="invite-player"),
    path(
        "game/get-status/<int:game_id>/",
    ...
    path(
        "profile/stats/<str:username>/", GetUserStats.as_view(), name="get-user-stats"
    ),
]
